...
class Cola:
    """ Representa una cola donde agrega, quita de la cola, y
...
print("Bienvenido:")
opcion=int(input("Digite la cantidad de vehículos que desea ingresar"))
while(opcion!=0):
...
opcion=int(input("Digite la cantidad de vehículos que desea ingresar"))*2 
while(opcion!=0):
    cola.quitar()
    opcion=opcion-1
print(cola.items)
